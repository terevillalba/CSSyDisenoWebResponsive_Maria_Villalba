			...
			return(
				<li className="cart-item" key={product.name}>
                    ...
                    <div className="product-total">
                        <p className="quantity">{product.quantity} {product.quantity > 1 ?"Cant." : "Cant." } </p>
        ...
        return(
            <header>
                <div className="container">
                    <div className="brand">
                        <img className="logo" src="../src/assets/logo.png" alt="Tienda Tere"/>
                    </div>

                    <div className="search">
                        <a className="mobile-search" href="#" onClick={this.handleMobileSearch.bind(this)}><img src="../src/assets/lupa.png" alt="buscar"/></a>
                        <form action="#" method="get" className={this.state.mobileSearch ? "search-form active" : "search-form"}>
                            <a className="back-button" href="#" onClick={this.handleSearchNav.bind(this)}><img src="../src/assets/back.png" alt="atras"/></a>
                            <input type="search" ref="searchBox" placeholder="Buscar" className="search-keyword" onChange={this.props.handleSearch}/>
                    ...
                    <div className="cart">
                        ...
                        <a className="cart-icon" href="#" onClick={this.handleCart.bind(this)} ref="cartButton">
                            <img className={this.props.cartBounce ? "tada" : " "} src="../src/assets/shopping-cart.png" alt="Cart"/>
                        ...
                        <div className={this.state.showCart ? "cart-preview active" : "cart-preview"} ref="cartPreview">
                            ...
                            <div className="action-block">
                                <button type="button" className={this.state.cart.length > 0 ? " " : "disabled"}>COMPRAR</button>
                            </div>
                        </div>
                    </div>
                </div>
